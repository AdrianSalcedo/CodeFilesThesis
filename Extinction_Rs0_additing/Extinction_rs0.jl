...
path =
    "D:/Julia_code_for_tomate_SDE_paper-main/Extinction_Rs0_additing/"

include(path * "Dynamics.jl")
#=
Parameters = CSV.read(path * "Parameter_Extinction_rs0_5.csv", DataFrame)
...
CSV.write(path * "Det_solution_rs_extinction_additing_7.csv",det_DF1_red)
...
CSV.write(path * "Stc_solution_rs_extinction_additing_7.csv",stc_DF1_red)
