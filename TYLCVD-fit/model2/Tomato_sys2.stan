functions {
  ...
  real dy_dt[6];
      ...
      real dSv_dt =  -betav * Sv * Ip  - (gamma + gammaf) * Sv + (1 - theta1) * mu;
      real dIv_dt =  betav * Sv * Ip - (gamma + gammaf) * Iv + theta1 * mu;
  ...
  real<lower= 0, upper = 0.1> betap;
  real<lower= 0.008, upper = 0.1> r_1;
  real<lower= 0.008, upper = 0.1> r_2;
  real<lower= 0, upper = 0.5> gammaf;
  real<lower = 0, upper = 1> Sp0;  // initial fraction of susceptible individuals
  }
