...
|$S_p$                  |y[1]| $S_{p_0}$               |y_init[1]|$N_p -
                                                                  (L_{p_0} + 
                                                                  I_{p_0})$  |
|$L_p$                  |y[2]| $L_{p_0}$               |y_init[2]|0.01        |
|$I_p$                  |y[3]| $I_{p_0}$               |y_init[3]|0          |
|$S_v$                  |y[4]| $S_{v_0}$               |y_init[4]|0.05        |
|$I_v$                  |y[5]| $I_{v_0}$               |y_init[5]|0.03|
|$I_p^{[cumulative]}$   |y[6]| $I_{p_0}^{[cumulative]}$|y_init[6]|0          |

Observation Model
=================
\begin{align}
    Y_t &
        \sim \text{Exponential}\big(\frac{1}{\lambda_t}\big), \qquad
    \\
    \lambda_t &
        =  \int_0^t b L_p
    \\
...
|-------------|---------   |---------------|------------|
|theta[1]     |$\beta_p$   | Normal(0.007570614,0.001291196)|            |
|theta[2]     |$r_1$       | -----------   |    0.01    |
|theta[3]     |$r_2$       | -----------   |    0.01    |
|theta[4]     |$b$         | Normal(0.01, 0.0001)|            |
|theta[5]     |$\beta_v$   | Normal(0.026894359,0.044418103) |            |
|theta[6]     |$\gamma$    |  -----------  |    0.06    |
|theta[7]     |$\gamma_f$  |  -----------  |    0.06    |
|theta[8]     |$\theta$    | Unif(0.0001, 0.75)|            |
|theta[9]     |$\mu$       | Unif(0.25, 0.75)|            |
|y_init[1]    |$S_{p_{0}}$ |  -----------  | $1 - L_{p_0} + I_{p_0}$   |
|y_init[2]    |$L_{p_{0}}$ | Unif(0.0, 0.05)  |            |
|y_init[3]    |$I_{p_{0}}$ |  -----------  |            |
|y_init[4]    |$S_{v_{0}}$ | Unif(0.0, 0.01)  |            |
|y_init[5]    |$I_{v_{0}}$ | Normal(0.01, 0.0001)  |            |
...
```{r}
library(rstan)
writeLines(readLines("SIR_Tomato.stan"))
```