...
#include "header_boundarycond"
{
    ...
    boundary_conditions[9] = initial_state[9];
    boundary_conditions[10] = initial_state[10];
    boundary_conditions[11] = initial_state[11];
    boundary_conditions[12] = final_state[10];
