...
det_sol = solve(prob_det, Tsit5(), dt = dt,saveat = 1.0)
########################## Stochastis Solution #################################
...
p1 = plot!(
circles.Time_LA_1582, circles.LA_1582, seriestype = :scatter, color="red", legend = false
)
# p1 = plot!(
...
CSV.write(path * "Data_noise_incidence_LA_1582_additing.csv",Datos)
