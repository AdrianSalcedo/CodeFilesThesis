...
beta_p = 0.1
r_1 =  1.069008/100#0.01
r_2 =  1.067034/100#0.01
b =  6.098809/100#0.075
beta_v = 1.000496/100#0.01
theta = 0.4
mu = 1.0
gamma = 0.03
gamma_f = 0.01

sigma_L = 0.310875#0.065603
sigma_I = 0.365496#0.850319
sigma_v = 0.574041#0.722428
...
dt = 0.001
t_s =  Vector(0:T)
EndemicIpcoord = 0.133279* ones(Int(T)+1)#0.780454 * ones(Int(T)+1)
...
p2 = plot!(t_s, EndemicIpcoord, color = "darkgreen", legend = false)
ylims!(-0.01, 1.05)
...
CSV.write(path * "Det_Rs0_per_Holt.csv",det_DF1_red)
...
det_DF1 = DataFrame(t = det_Time,S_p = Xu1, L_p =Xu2, I_p = Xu3, S_v = Xu4, I_v = Xu5)
det_DF1_red = det_DF1#[1:10:end,1:end]
CSV.write(path * "Det_Rs0_add_per_good.csv",det_DF1_red)
...
CSV.write(path *"Stc_Rs0_add_per_good.csv",stc_DF1_red)
