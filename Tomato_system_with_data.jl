...
path2 = "/Julia_code_for_tomate_SDE_paper-main-master/"
path = path1 * path2
...
u_0 = [0.989,0.01,0.001,0.7,0.3,0.0]#[0.998,0.001,0.001,0.2,0.1,0.0001]
T = 70.0
time = (7.0,T)
...
CSV.write(path * "Det_Noise_ext_Holt.csv",det_DF1_red)
