...
path1 = "/media/gabrielsalcedo/ADATA HV620S/Julia_code_for_tomate_SDE_paper-main/"
...
dt = 0.001
t_s =  Vector(0:T)
EndemicIpcoord = 0.780454 * ones(Int(T)+1)
...
det_DF1 = DataFrame(t = det_Time,S_p = Xu1, L_p =Xu2, I_p = Xu3, S_v = Xu4, I_v = Xu5)
det_DF1_red = det_DF1#[1:10:end,1:end]
CSV.write(path * "Det_Rs0_sub_per_good.csv",det_DF1_red)
...
CSV.write(path *"Stc_Rs0_sub_per_good.csv",stc_DF1_red)
