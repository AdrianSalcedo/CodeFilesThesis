...
p1 = plot!(
Resistance.Time_LA_1582, Resistance.LA_1582, seriestype = :scatter, color="black", legend = false
)
################################################################################
...
CSV.write(path0 * "Data_persistence_incidence_LA_1582_substracting.csv",Datos)
