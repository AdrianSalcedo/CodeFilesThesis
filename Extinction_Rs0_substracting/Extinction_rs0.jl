...
Parameters = CSV.read(path * "Parameter_Extinction_rs0_substracting_3.csv", DataFrame)
...
CSV.write(path * "Det_solution_rs_extinction_substracting_3.csv",det_DF1_red)
...
CSV.write(path * "Stc_solution_rs_extinction_substracting_3.csv",stc_DF1_red)
